...
def handle_rules_create(handler):
    """POST /api/rules/create — create a new alert rule."""
...
def handle_rules_update(handler):
    """POST /api/rules/update — update an existing alert rule (enable/disable/modify)."""
...
def handle_rules_delete(handler):
    """POST /api/rules/delete — delete an alert rule."""
...
def handle_playbooks_create(handler):
    """POST /api/playbooks/create — create a new playbook from parameters."""
