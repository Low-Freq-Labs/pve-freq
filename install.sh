...
_detect_version() {
    ...
    echo "2.2.0"  # fallback — keep in sync with freq/__init__.py
}
...
post_install() {
    ...
    echo -e "    1. Edit ${C_CYAN}${INSTALL_DIR}/conf/freq.toml${C_RESET} with your cluster details"
    echo -e "    2. Run ${C_CYAN}sudo freq init${C_RESET} to set up fleet access"
    echo -e "    3. Run ${C_CYAN}freq doctor${C_RESET} anytime to check health"
    echo ""
